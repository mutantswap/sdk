...
export const FACTORY_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.AURORA]: '0xB934cF2B1eBFbC742B403568Db1Ef1B8EAD3fC56'
}
...
export const ROUTER_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.AURORA]: '0x53F7A774783914a4BccDCEB2416530Ba2DB76c59'
}
...
export const INIT_CODE_HASH: { [chainId in ChainId]: string } = {
  ...
  [ChainId.AURORA]: '0x19885afea98f14cb9106752962febf3a5522d07503126d3b0a591721174ed35c'
}
